...
public class SysGroupFundDetailImpl extends ServiceImpl<SysGroupFundDetailMapper, SysGroupFundDetail> implements SysGroupFundDetailService {
        ...
        @Override
        public SysGroupFundDetail getByGroupCategory(String category1, Long fundId, Long groupId) {
            return this.getOne(new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<SysGroupFundDetail>().eq(SysGroupFundDetail::getCategory1,category1).eq(SysGroupFundDetail::getFundingId,fundId).eq(SysGroupFundDetail::getGroupId,groupId));
        }
